...
app.listen(process.env.port || 5454,function(err){
  ...
  mongoose.connect(`mongodb://${config.mongodb.server}:${config.mongodb.port}/mnr`,{ useNewUrlParser: true });
	console.log("====> M&R app is listening on port listening on port: 5454 <====");
})
